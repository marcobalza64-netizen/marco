...
try:
    ...
    print("  python3 -m pip install -r requirements-spectrum.txt")
    sys.exit(1)
except OSError as exc:
    print("PortAudio non trovato (serve per il microfono).")
    print(f"Dettaglio: {exc}")
    print("Sul Mac di solito basta: pip install -r requirements-spectrum.txt")
    print("Su Linux: sudo apt install libportaudio2 portaudio19-dev")
    sys.exit(1)
